...
def get_test_info(sal_mode='e'):
    if sal_mode == 'e':
        ...
        image_root = '../user_data/test_data/match/splicing'
        image_source = '../user_data/test_data/match/splicing.txt'
...
if __name__ == '__main__':
    ...
    res2net_path = 'pretrained_model/res2net50_v1b_26w_4s-3cf99910.pth'
